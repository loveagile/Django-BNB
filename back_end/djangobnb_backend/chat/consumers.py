...
from asgiref.sync import sync_to_async # to be able to store responses to the db
...
class ChatConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        await self.channel_layer.group_add( # talks to the temporary storage set in the settings.py
